...
public class DiscountCalcController {

     
    private DiscountCalcView theView;
    private DiscountCalcModel theModel;
     

    public DiscountCalcController(DiscountCalcView theView, DiscountCalcModel theModel) {
